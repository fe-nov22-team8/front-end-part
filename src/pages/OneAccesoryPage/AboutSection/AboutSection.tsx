...
export const AboutAccessory: React.FC = () => (
  <div className="AboutAccessory">
    <h2 className="AboutAccessory__title">About</h2>

    <h3 className="AboutAccessory__subtitle">And then there was Pro</h3>

    <p className="AboutAccessory__text">
    ...
    <h3 className="AboutAccessory__subtitle">Camera</h3>
    ...
    <h3 className="AboutAccessory__subtitle">
